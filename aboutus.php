                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Our mission is to provide the best bus services in the region, ensuring comfort, safety, and reliability for all our passengers. We are dedicated to making transportation accessible and convenient for everyone.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Established in 2000, our company has grown from a small fleet of buses to a large network of routes serving numerous cities and towns. Our commitment to excellence has driven us to continuously improve and expand our services.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Our team comprises experienced professionals who are passionate about delivering top-notch service. From our drivers to our customer service representatives, every member of our team plays a crucial role in ensuring a pleasant journey for our passengers.</p>
                        </div>
                    </div>
                </div>
            </div>
