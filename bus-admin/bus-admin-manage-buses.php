...
<div class="container-fluid main-content">
  <h1 class="booking-header">Manage Buses</h1>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="action-buttons">
          <a href="bus-admin-update-bus.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Update</a>
          <a href="bus-admin-manage-buses.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this bus?');">Delete</a>
        </td>
      </tr>
      <?php } ?>
    </tbody>
