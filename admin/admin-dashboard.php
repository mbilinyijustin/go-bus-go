...
<body>
                ...
                <div class="col-lg-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="admin-manage-buses.php" class="btn btn-primary"><i class="fa fa-bus"></i> Manage Buses</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="admin-manage-users.php" class="btn btn-primary"><i class="fa fa-users"></i> Manage Users</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="card text-center">
        <div class="card-body">
            <i class="fa fa-id-card card-icon"></i>
            <h5 class="card-title">Manage Bus Admins</h5>
            <p class="card-text">Add, edit, or delete bus admin accounts.</p>
            <a href="admin-manage-bus-admin.php" class="btn btn-primary"><i class="fa fa-id-card"></i> Manage Bus Admins</a>
        </div>
    </div>
</div>
